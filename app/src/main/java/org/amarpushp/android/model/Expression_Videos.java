...
public class Expression_Videos {

    private int image;
    private String competition_name, competition_year;

    public Expression_Videos(int image, String competition_name, String competition_year) {
        this.image = image;
