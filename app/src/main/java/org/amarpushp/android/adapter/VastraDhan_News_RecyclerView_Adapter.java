...
public class VastraDhan_News_RecyclerView_Adapter extends RecyclerView.Adapter<VastraDhan_News_RecyclerView_Adapter.ViewHolder> {
    private static final String TAG = "News_Recyler_View_Adapter";
    private List<VastraDhan_News>news_items;
    Context mContext;

    public VastraDhan_News_RecyclerView_Adapter(VastraDhan_News news_item, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mContext).inflate(R.layout.vastradhan_news,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            news_Image=(ImageView)itemView.findViewById(R.id.vastradhan_newsimageview);
            news_textView=(TextView) itemView.findViewById(R.id.vastradhan_newstextview);
